...
# Compare to R:
# print(paste("this","is","one","string", sep = ""))


# Compare to python 2.7:
# print "my_string"
# But this is invalid syntax in Python 3.
...
# Try something that shouldn't work.
x[0:2]*3
...
# Rewrite this another way:
yet_another_boolean_ind = not (x == 5)
# But this fails in Python:
# yet_another_boolean_ind = ! (x == 5)
# (but it works). 
...
for a in 'words':
    print(w)
# What happened? "s" was the last definition of w.

for a in 'words':
    print(a)

# More informative syntax:
for letter in 'words':
    print(letter)
...
# Note that i -= 1 decrements the variable i. 
# i.e. it means i = i - 1
