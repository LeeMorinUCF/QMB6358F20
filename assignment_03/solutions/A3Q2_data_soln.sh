...
# Move to folder containing iris files.
cd ../../../../Assignments/assignment_03/A3_iris_data/QMB6358-iris

echo "List of files in iris folder:"
ls -lh
...
do
    ...
    cat iris_$FILE_NUM.txt >> A3Q2a_full.txt
...
# Move to folder containing R scripts.
cd ../../../../GitRepos/QMB6358F20/assignment_03/solutions/


# Run the R script and save the output
echo "Running R script for Question 1..."
Rscript A3Q1_data_soln.R > A3Q1_results_soln.out
...
Rscript A3Q2_tests_soln.R > A3Q2_results_soln.out
